      ...
      <div className="flex-1 md:ml-60 flex flex-col min-h-screen">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
          ...
          <div className="relative">
            <button onClick={() => setProfileOpen(!profileOpen)}
              className="w-9 h-9 rounded-full bg-green-600 text-white flex items-center justify-center font-semibold text-sm"
            >
              {initials}
            </button>
            {profileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-lg z-50 overflow-hidden">
                <div className="px-4 py-3 border-b border-gray-100 flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-800">{technicianName}</p>
        ...
        <main className="p-6 w-full">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm">Manage incoming service requests</p>
          </div>
