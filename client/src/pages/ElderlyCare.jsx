...
export default function ElderlyCarePlans() {
  ...
  const plans = t("elderlyCarePlans.plans", { returnObjects: true });

  return (
    <>
      <Navbar />
      <section className="py-25 bg-linear-to-br from-blue-50 to-cyan-100 px-6">
        ...
        >
          <img
            ...
            alt={t("elderlyCarePlans.heading")}
          ...
          {plans.map((plan, i) => (
            ...
            >
              ...
              <p className="text-center text-xs text-orange-500 mt-2">
                {t("elderlyCarePlans.limitedSlots")}
              </p>
              ...
              >
                {t("elderlyCarePlans.chooseButton")}
              </button>
        ...
        >
          ...
          >
            <FaPhoneAlt /> {t("elderlyCarePlans.callButton")}
          </a>

          <p className="mt-4 text-sm text-gray-500">
            {t("elderlyCarePlans.trustedText")}
          </p>
        </motion.div>
