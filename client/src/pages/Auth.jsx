...
import { FaUser, FaUserMd, FaUserShield, FaUserNurse } from "react-icons/fa";
    ...
    <div className="min-h-screen flex bg-linear-to-br from-blue-100 to-blue-300">
      ...
      <div className="hidden md:flex w-1/2 items-center justify-center p-10">
        <div className="text-center">
          ...
          />
          <h1 className="text-4xl font-bold text-blue-700 mb-3">MedKit</h1>
      ...
      <div className="flex w-full md:w-1/2 justify-center items-center px-6">
        <div className="bg-white/70 backdrop-blur-xl p-8 rounded-2xl shadow-2xl w-full max-w-md">
          ...
          {!selectedRole ? (
            <>
              <h2 className="text-2xl font-bold text-center mb-6">Choose Role</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div
                  ...
                  className="cursor-pointer bg-white p-5 rounded-xl shadow hover:shadow-xl hover:scale-105 transition text-center border"
                >
                ...
                <div
                  ...
                  className="cursor-pointer bg-white p-5 rounded-xl shadow hover:shadow-xl hover:scale-105 transition text-center border"
                >
                  <FaUserNurse className="mx-auto text-3xl text-purple-500 mb-2" />
                  <p className="font-medium">Technician</p>
                  <p className="text-xs text-gray-400 mt-1">Home services</p>
                </div>
                ...
                >
                  ...
                  <p className="text-xs text-gray-400 mt-1">Manage platform</p>
                </div>
